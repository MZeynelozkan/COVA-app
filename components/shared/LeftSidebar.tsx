...
const LeftSidebar = () => {
  ...
  return (
    <div className="sticky left-0 top-0 flex h-dvh w-full max-w-[320px]  flex-col justify-between pt-36   max-lg:w-[60px] max-lg:px-2  max-sm:hidden overflow-y-auto">
