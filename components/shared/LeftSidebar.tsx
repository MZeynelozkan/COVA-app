...
const LeftSidebar = () => {
  ...
  return (
    <div className="sticky top-0 flex size-full min-h-[calc(100vh-65px)] max-w-[320px] flex-col  justify-between  px-4 pb-5 pt-9 max-lg:w-[60px] max-lg:px-2  max-sm:hidden">
